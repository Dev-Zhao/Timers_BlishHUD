...
namespace Charr.Timers_BlishHUD.Controls.Alerts
{
    public class AlertContainerMover : Control, IWindow
    {
        ...
        public AlertContainerMover(params ScreenRegion[] screenPositions) : this(screenPositions.ToList()) { /* NOOP */ }

        public AlertContainerMover(IEnumerable<ScreenRegion> screenPositions) {
            ...
            _handleTexture = TimersModule.ModuleInstance.ContentsManager.GetTexture("textures/handle.png");
        }
